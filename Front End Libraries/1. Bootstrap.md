...
The `.btn-primary` will color the button to Bootsrap's primary color (blue).
...
The `span` element can be used to put several elements together, and even style differen parts of the same element differently.
...
The Bootstrap `.well` class can createa  visual sense of depth for your columns.
