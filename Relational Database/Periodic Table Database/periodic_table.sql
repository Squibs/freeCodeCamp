...
--
-- Name: properties elements_atomic_number_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT elements_atomic_number_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
